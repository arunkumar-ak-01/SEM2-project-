                        ...
                        <Row>
                            ...
                            <Col lg={8}>
                                <Container>
                                    ...
                                    <Row>
                                        <Col lg={7}>
                                            <span style={{fontVariant: "small-caps"}}>Order Value:</span><br />
                                            {/* <span style={{fontVariant: "small-caps"}}>Item Discount:<span style={{ float: "right" }}>(-)</span></span><br /> */}
                                            <span style={{fontVariant: "small-caps"}}>Payment Mode: COD</span>
                                        </Col>
                                        <Col lg={5}>
                                    ...
                                    <Row>
                                        <Col lg={1}></Col>
                                        <Col lg={5}>
                                            <h5 style={{fontVariant: "large-caps"}}><b>Grant Total:</b></h5>
                                        </Col>
                                        <Col lg={4}>
                                            <h5><b>{numberFormat(total)}</b></h5>
                                        </Col>
                                    </Row>
                                </Container>
                            </Col>
