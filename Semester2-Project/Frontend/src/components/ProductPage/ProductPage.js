                ...
                <Container key={filter.code} fluid={true}>
                    ...
                    <Row>
                        ...
                        <Col className="col-lg-4 col-md-12" style={{ padding: "10px 0px" }}>
                            ...
                            {/* <span style={{ padding: "50px 0px 10px 0px" }}><span className="calprice">{numberFormat(Math.floor((filter.price) - (((filter.price) / 100) * (filter.offer))))}</span> */}
                            <span className="value"><b>{numberFormat(filter.price)}</b></span><b className="offerprice">({filter.offer}10% OFF)</b>
                            <p style={{ color: "LightSeaGreen" }}>Inclusive of All Taxes & Discounts </p>
                            <br />
                            <br />
                            <h6>SELECT SIZE:  </h6>
                            {filter.size.map(x => (
                            ...
                            <br />
                            <p style={{ marginTop: "10px", fontWeight: "600" }}>100% hnd made craft gifts, Present and suprise your friends with this wonderful gifts</p>
                            <p style={{ marginTop: "5px" }}>products that we are selling are 100% worth of money and enjoy your shopping experience with us </p>
                            <br />
